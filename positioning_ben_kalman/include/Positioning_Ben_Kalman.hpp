...
class positioning_ben_class : public rclcpp::Node {
    public:
        positioning_ben_class();
        ~positioning_ben_class();
        void PublishData();
        ...
        void GPSFix_Callback(const gps_msgs::msg::GPSFix::ConstPtr& gps_received);
    ...
    //SUBSCRIBERS
        ...
        rclcpp::Subscription<gps_msgs::msg::GPSFix>::SharedPtr BenSub;
    ...
    //PUBLISHERS
        ...
        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr PoseMetersPublisher;
        geometry_msgs::msg::PoseStamped pose_meters_msg;

        rclcpp::Publisher<geometry_msgs::msg::PoseStamped>::SharedPtr PoseParkPublisher;
        geometry_msgs::msg::PoseStamped pose_park_msg;
